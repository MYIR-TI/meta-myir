...
do_install (){
	...
	if [ -f ${DEPLOY_DIR_IMAGE}/../myd-am62x-rt-emmc/myir-image-core-myd-am62x-rt-emmc.rootfs.wic ]; then
		install -m 0755 ${DEPLOY_DIR_IMAGE}/../myd-am62x-rt-emmc/myir-image-core-myd-am62x-rt-emmc.rootfs.wic ${D}/root/mfgimage/rootfs.wic
	else
		bbwarn "WIC image not found: ${DEPLOY_DIR_IMAGE}/../myd-am62x-rt-emmc/myir-image-core-myd-am62x-rt-emmc.rootfs.wic"
	fi
}
