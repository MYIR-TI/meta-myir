SUMMARY = "fac-burn-emmc-core-rt configure files"
DESCRIPTION = "fac-burn-emmc-core-rt files"
...
SRC_URI = " \
		file://usr/lib/systemd/system/fac-burn-emmc-core-rt.service \
...
do_install (){
	...
	install -m 0644 ${WORKDIR}/usr/lib/systemd/system/fac-burn-emmc-core-rt.service ${D}/usr/lib/systemd/system 
	...
	if [ -f ${DEPLOY_DIR_IMAGE}/../myd-ym62x-rt-emmc/myir-image-core-myd-ym62x-rt-emmc.rootfs.wic ]; then
		install -m 0755 ${DEPLOY_DIR_IMAGE}/../myd-ym62x-rt-emmc/myir-image-core-myd-ym62x-rt-emmc.rootfs.wic ${D}/root/mfgimage/rootfs.wic
	else
		bbwarn "WIC image not found: ${DEPLOY_DIR_IMAGE}/../myd-ym62x-rt-emmc/myir-image-core-myd-ym62x-rt-emmc.rootfs.wic"
	fi
}
...
FILES:${PN} = "\
		...
		/usr/lib/systemd \
		/usr/lib/systemd/system \
		/usr/lib/systemd/system/fac-burn-emmc-core-rt.service \
"
SYSTEMD_PACKAGES = "${PN}"
SYSTEMD_SERVICE:${PN} = "fac-burn-emmc-core-rt.service"
