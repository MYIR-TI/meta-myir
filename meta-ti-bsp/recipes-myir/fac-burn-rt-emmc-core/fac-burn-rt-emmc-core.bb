...
do_install (){
	...
	install -m 0755 ${DEPLOY_DIR_IMAGE}/../myd-ym62lx-rt-emmc/tiboot3.bin ${D}/root/mfgimage
	install -m 0755 ${DEPLOY_DIR_IMAGE}/../myd-ym62lx-rt-emmc/tispl.bin ${D}/root/mfgimage
	install -m 0755 ${DEPLOY_DIR_IMAGE}/../myd-ym62lx-rt-emmc/u-boot.img ${D}/root/mfgimage
	install -m 0755 ${DEPLOY_DIR_IMAGE}/../myd-ym62lx-rt-emmc/myir-image-core-myd-ym62lx-rt-emmc.rootfs.wic ${D}/root/mfgimage
}
