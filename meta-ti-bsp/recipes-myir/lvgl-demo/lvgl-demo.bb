...
SRC_URI = "git://github.com/lvgl/lvgl.git;protocol=https;branch=release/v8.2;name=lvgl;destsuffix=lvgl \
		   git://github.com/lvgl/lv_drivers.git;protocol=https;branch=release/v8.2;name=lvdrivers;destsuffix=lv_drivers \
		"
