...
#  define LIBINPUT_NAME   "/dev/input/touchscreen0"        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
...
#    define EVDEV_HOR_MAX      1200               /*"evtest" Linux tool can help to get the correct calibraion values>*/
#    define EVDEV_VER_MIN         0
#    define EVDEV_VER_MAX      1920
